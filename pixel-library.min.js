(function() {
  ...
  // query parameters):
  api.addTimestamp = function(n) {
    data["timestamp"] = $.now();
  };

  api.addUrl = function(c) {
    data["url"] = $(location).attr("href");
  };

  api.addCourse = function(p) {
    data["course"] = p;
  };
  ...
  api.send = function() {
    ...
    pixel.src = "http://127.0.0.1:4000/" + pixelId + "/pixel.png?" + queryParams;
  ...
  var execute = function() {
    console.log(JSON.stringify(window.crl8.q));
